...
## Contribute
Currently project does not accept any contribution as I am working on core files, in few days you'll be able to contribute translations,code etc.
Meanwhile if you found any bug, please [create issue here](https://github.com/kaustubhk24/EasyURLs/issues/new)
